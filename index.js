...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:diegin2k\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511998346168:+55 11 99834-6168\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.'
blocked = []
limitawal = '999999999'
...
const _leveling = JSON.parse(fs.'./database/group/leveling.json'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ espere  so um pouco ',
					success: '️❬ ✔ ❭ Ae manin, seja feliz mn',
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD diegin2k BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] diegin2k? Este é um recurso especial para o diegin2k ❌',
					ownerB: '[❗] diegin2k? Este é um recurso especial para o diegin2k ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de diegin2k. Registre-se para fazer amizade com o bot diegin2k por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar diegin2k|17\n\n──「 diegin2k BOT 」──`,
			...
			const ownerNumber = ["5511998346168@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511998346168@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5511998346168@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5511998346168@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5511998346168@s.whatsapp.net","558296156440@s.whatsapp.net"] 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("diegin2k")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/diegin2kf.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS diegin2k BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @diegin2k domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o diegin2k ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT diegin ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *diegin2k* 」*────*\n\n*_SE QUER SER ADMIN DO BOT diegin2k_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5511998346168/*╰──────*「 * diegin2k* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO diegin2k BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do diegin2k:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
